...
**[ZeroTool JSON フォーマッター →](/tools/json-formatter)**
...
[ZeroTool JSON フォーマッター](/tools/json-formatter)では圧縮も対応しています。整形済みのJSONを貼り付けて**Minify**をクリックするだけです。
...
| タスク | ツール |
|--------|--------|
| 素早く整形・検証 | [ZeroTool JSON フォーマッター](/tools/json-formatter) |
| CLIで整形 | `jq .` |
...
**[ZeroTool JSON フォーマッターで今すぐ整形 →](/tools/json-formatter)**
