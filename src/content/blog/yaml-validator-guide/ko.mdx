...
[YAML 지금 검증하기 →](/ko/tools/yaml-validator/)
...
로컬에서 도구를 실행하지 않고 빠른 구문 검사와 구조 검사를 원한다면 [ZeroTool의 YAML 검증기](/ko/tools/yaml-validator/)가 브라우저 안에서 처리합니다:
...
**[YAML 검증기 사용해보기 →](/ko/tools/yaml-validator/)**
