...
**[JWT 토큰 생성하기 →](/tools/jwt-generator)**
...
1. [JWT 생성기](/tools/jwt-generator)를 엽니다
...
생성한 토큰이 유효한지 확인하려면 같은 시크릿과 알고리즘과 함께 토큰을 [JWT 디코더](/tools/jwt-decoder)에 붙여넣으세요. 디코더가 디코딩된 헤더와 페이로드를 표시하고 서명이 유효함을 확인합니다.
...
- [JWT 디코더 →](/tools/jwt-decoder) — 기존 JWT 토큰을 디코딩하고 검사하기
- [HMAC 생성기 →](/tools/hmac-generator) — HMAC 서명 직접 계산하기
- [해시 생성기 →](/tools/hash-generator) — SHA-256 등 해시 생성하기

---

서버 없이 몇 초 만에 서명된 JWT 생성. **[JWT 생성기 열기 →](/tools/jwt-generator)**
