...
[アスペクト比を即座に計算 →](/ja/tools/aspect-ratio/)
...
手で計算する代わりに、[ZeroToolのアスペクト比計算機](/ja/tools/aspect-ratio/)がブラウザ上で直接計算します。幅・高さ・目標寸法のうち任意の2つを入力すると、比率・不足寸法・一般的な標準の等価解像度を計算します。サインアップ不要、データはサーバーに送信されません。

**[ZeroTool アスペクト比計算機を試す →](/ja/tools/aspect-ratio/)**
