...
文字のエンティティを調べたり、ソースコードで見かけたエンティティをデコードしたい場合、最速の方法は専用のエンコーダー/デコーダーです。**[ZeroTool HTML エンティティツールを試す →](/ja/tools/html-entity/)**
...
**[HTML エンティティを即座にエンコード・デコード →](/ja/tools/html-entity/)**
