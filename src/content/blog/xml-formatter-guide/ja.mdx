...
[XMLをすぐに整形・検証する →](/tools/xml-formatter)
...
ミニファイされたXMLや手書きのXMLは読みにくくデバッグしにくいです。[ZeroToolのXMLフォーマッター](/tools/xml-formatter)は適切なインデントでXMLをプリティプリントし、構文エラーをハイライトして構造的な問題を検出します。データはどこにも送信されません。
...
**[XMLをすぐに整形する →](/tools/xml-formatter)**
