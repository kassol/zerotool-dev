...
[XML 즉시 정렬·검증하기 →](/tools/xml-formatter)
...
축소되거나 손으로 작성된 XML은 읽기 어렵고 디버깅하기 힘듭니다. [ZeroTool의 XML 포매터](/tools/xml-formatter)는 적절한 들여쓰기로 XML을 보기 좋게 출력하고, 구문 오류를 강조하며 구조적 문제를 잡아냅니다. 데이터는 어디에도 전송되지 않습니다.
...
**[XML 즉시 정렬하기 →](/tools/xml-formatter)**
