...
A [URL Encode/Decode tool](/tools/url-encode-decode) lets you:
...
A [Text Case Converter](/tools/text-case-converter) handles all of this instantly: camelCase, PascalCase, snake_case, kebab-case, UPPER_CASE, Title Case — pick your target format and paste the input.
