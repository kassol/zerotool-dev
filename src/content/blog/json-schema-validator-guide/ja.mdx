...
[今すぐ JSON をスキーマでバリデートする →](/ja/tools/json-schema-validator/)
...
スキーマをサンプルデータに対してローカルでテストするには、バリデーターのセットアップ・ファイルの読み込み・コードの実行が必要です。[ZeroTool の JSON Schema バリデーター](/ja/tools/json-schema-validator/)はそのすべての手間をなくします：
...
**[JSON Schema バリデーターを試す →](/ja/tools/json-schema-validator/)**
