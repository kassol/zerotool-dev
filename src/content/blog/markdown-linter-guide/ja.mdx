...
[Markdown Linter を試す →](/ja/tools/markdown-linter/)
...
両方使うのが正解です。CIでLintを回してルールを強制し、ローカルでプレビューを使って表示を確認する。[Markdown プレビューツール](/ja/tools/markdown-preview/) はLinterと相互補完になります。
...
**[Markdown Linter を開く →](/ja/tools/markdown-linter/)**
