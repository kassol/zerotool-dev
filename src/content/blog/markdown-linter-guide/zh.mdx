...
[立即检查 Markdown →](/zh/tools/markdown-linter/)
...
两者配合使用效果最好：CI 中 lint 保证规范，本地用预览确认效果。[Markdown 预览工具](/zh/tools/markdown-preview/)与 lint 检查互为补充。
...
**[打开 Markdown Lint 检查工具 →](/zh/tools/markdown-linter/)**
