...
[Markdown Linter 열기 →](/ko/tools/markdown-linter/)
...
둘 다 쓰는 게 정답입니다. CI에서 Lint로 규칙을 강제하고, 로컬에서 미리보기로 표시를 확인하세요. [Markdown 미리보기 도구](/ko/tools/markdown-preview/)는 Linter와 상호 보완 관계입니다.
