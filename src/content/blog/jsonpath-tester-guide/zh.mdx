...
[立即使用 JSONPath 测试工具 →](/zh/tools/jsonpath-tester/)
...
每次测试都要加载库、解析 JSON、写查询代码——效率很低。[JSONPath 测试工具](/zh/tools/jsonpath-tester/) 完全在浏览器中运行：

- 左侧粘贴 JSON，右侧输入表达式，结果即时显示
- 在原始 JSON 树中高亮匹配节点
- 无需安装，无需后端，无需登录

**[立即体验 JSONPath 测试工具 →](/zh/tools/jsonpath-tester/)**
