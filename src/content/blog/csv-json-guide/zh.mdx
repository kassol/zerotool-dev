...
[在线 CSV↔JSON 转换工具 →](/zh/tools/csv-json/)
...
不想写代码？[ZeroTool 的 CSV↔JSON 在线转换器](/zh/tools/csv-json/)完全在浏览器内运行，支持粘贴文本或上传文件，可调整分隔符、类型解析、表头处理等选项，转换结果可直接下载。不上传任何数据到服务器。

**[立即使用 CSV↔JSON 转换器 →](/zh/tools/csv-json/)**
