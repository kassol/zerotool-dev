...
[今すぐCSVをJSONに変換 →](/ja/tools/csv-json/)
...
クイックなアドホック変換には、[ZeroToolのCSV↔JSONコンバーター](/ja/tools/csv-json/)がブラウザ上で完全動作します。CSVを貼り付けるかアップロードし、オプション（区切り文字・型解析・ヘッダー行）を調整してJSONをダウンロード。ファイルはサーバーに送信されません。

**[CSV↔JSONコンバーターを今すぐ試す →](/ja/tools/csv-json/)**
