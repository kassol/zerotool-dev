...
[ブラウザでテキストを AES 暗号化する →](/ja/tools/aes-encrypt-decrypt/)
...
[ZeroTool の AES Encrypt/Decrypt ツール](/ja/tools/aes-encrypt-decrypt/)は、Web Crypto API を使った AES-256-GCM をブラウザ内で実行します。平文も鍵もサーバーに送られません。テキストを貼り付けてパスワードを設定するだけで即座に暗号化・復号できます。

**[AES 暗号化ツールを試す →](/ja/tools/aes-encrypt-decrypt/)**
