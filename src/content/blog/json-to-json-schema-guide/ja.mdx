...
[JSON から JSON Schema を生成する →](/ja/tools/json-to-json-schema/)
...
[ZeroTool の JSON to JSON Schema ジェネレーター](/ja/tools/json-to-json-schema/)は、任意の JSON オブジェクトから完全な draft-07 スキーマをリアルタイムで推論します。JSON を貼り付けてスキーマをコピーし、バリデーションを開始できます。サインアップ不要で、すべてブラウザ内で動作します。

**[JSON to JSON Schema ジェネレーターを試す →](/ja/tools/json-to-json-schema/)**
