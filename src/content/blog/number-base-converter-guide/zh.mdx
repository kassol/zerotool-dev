...
手算容易出错，写代码又嫌麻烦？[ZeroTool 进制转换工具](/tools/number-base) 支持二进制、八进制、十进制、十六进制实时互转，在任意一栏输入数值，其他栏立刻更新，无需提交，数据不离开浏览器。

**[立即使用进制转换工具 →](/tools/number-base)**
