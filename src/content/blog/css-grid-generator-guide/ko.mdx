...
[CSS 그리드 생성기 사용해보기 →](/ko/tools/css-grid-generator/)
...
복잡한 레이아웃에서 `grid-template-columns`, `grid-template-rows`, `gap` 값을 수동으로 설정하면 시행착오가 필요합니다. [CSS 그리드 생성기](/ko/tools/css-grid-generator/)를 사용하면:
