...
[TOMLをJSONに即時変換 →](/ja/tools/toml-json/)
...
ツールをインストールせずにさっと変換するには、[ZeroToolのTOML↔JSONコンバーター](/ja/tools/toml-json/)がブラウザ内で完結します。TOMLを貼り付けるとJSONが得られます。データはサーバーに送信されません。

**[TOML↔JSONコンバーターを試す →](/ja/tools/toml-json/)**
