...
[TOML을 JSON으로 즉시 변환하기 →](/ko/tools/toml-json/)
...
도구를 설치하지 않고 빠르게 변환하려면 [ZeroTool의 TOML↔JSON 변환기](/ko/tools/toml-json/)가 브라우저 안에서 처리합니다. TOML을 붙여넣으면 JSON이 나옵니다. 데이터는 서버로 전송되지 않습니다.

**[TOML↔JSON 변환기 사용해보기 →](/ko/tools/toml-json/)**
