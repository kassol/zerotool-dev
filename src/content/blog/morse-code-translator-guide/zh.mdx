...
[在线摩斯电码翻译工具 →](/zh/tools/morse-code-translator/)
...
[ZeroTool 摩斯电码翻译工具](/zh/tools/morse-code-translator/) 支持文字与摩斯码的实时双向转换，覆盖 ITU 标准字母表、数字和常用标点。无需注册，全部在浏览器本地运行。

**[立即使用摩斯电码翻译工具 →](/zh/tools/morse-code-translator/)**
