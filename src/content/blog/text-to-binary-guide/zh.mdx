...
[在线文本转二进制 →](/zh/tools/text-to-binary/)
...
**[打开 ZeroTool 文本转二进制工具 →](/zh/tools/text-to-binary/)**
...
需要文本安全的紧凑编码时，推荐 [Base64 工具](/zh/tools/base64/)。需要同时查看十进制、十六进制、八进制时，推荐 [ASCII 转换器](/zh/tools/ascii-converter/)。
...
**[立即使用文本转二进制工具 →](/zh/tools/text-to-binary/)**
