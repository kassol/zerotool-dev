...
**[JSON에서 Python 데이터클래스 생성하기 →](/tools/json-to-python-dataclass)**
...
- [JSON to TypeScript →](/tools/json-to-typescript) — JSON에서 TypeScript 인터페이스 생성
- [JSON to Go Struct →](/tools/json-to-go-struct) — JSON에서 Go 구조체 생성
- [JSON Formatter →](/tools/json-formatter) — 변환 전에 JSON 정형화 및 검증

---

JSON을 붙여넣고 출력 형식을 선택하세요. **[JSON to Python 데이터클래스 생성기 열기 →](/tools/json-to-python-dataclass)**
