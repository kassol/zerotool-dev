...
**[立即转换 TypeScript → Zod →](/tools/typescript-to-zod)**
...
- [JSON 转 Zod →](/tools/json-to-zod) — 从 JSON 数据样本生成 schema（适合有数据但没有类型定义的场景）
- [JSON 转 TypeScript →](/tools/json-to-typescript) — 反向：从 JSON 生成 TypeScript interface

---

粘贴 TypeScript interface，立即得到可用的 Zod schema。**[打开 TypeScript 转 Zod 工具 →](/tools/typescript-to-zod)**
