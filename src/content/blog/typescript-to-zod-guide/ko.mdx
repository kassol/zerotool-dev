...
**[TypeScript to Zod 변환하기 →](/tools/typescript-to-zod)**
...
- [JSON to Zod →](/tools/json-to-zod) — JSON 데이터 샘플에서 스키마 생성 (타입이 아닌 데이터가 있을 때)
- [JSON to TypeScript →](/tools/json-to-typescript) — JSON에서 TypeScript 인터페이스 생성 (반대 방향)

---

TypeScript 인터페이스를 붙여넣으면 몇 초 만에 동작하는 Zod 스키마를 얻을 수 있습니다. **[TypeScript to Zod 컨버터 열기 →](/tools/typescript-to-zod)**
