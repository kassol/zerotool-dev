...
[在线图片转 Base64 工具 →](/zh/tools/image-to-base64/)
...
> **提示：** [ZeroTool 的图片转 Base64 工具](/zh/tools/image-to-base64/)通过 `FileReader` 直接读取本地文件，不发起任何外部请求，不存在 CORS 问题。
...
不想写代码？[ZeroTool 的图片转 Base64 工具](/zh/tools/image-to-base64/)完全在浏览器内运行，拖入或选择图片，立即得到 Base64 字符串或完整 Data URI，不上传任何文件到服务器。

**[立即使用图片转 Base64 工具 →](/zh/tools/image-to-base64/)**
