...
[今すぐ画像を Base64 に変換する →](/ja/tools/image-to-base64/)
...
> **注**：[ZeroTool の画像コンバーター](/ja/tools/image-to-base64/)はローカルファイルに `FileReader` を使用します。外部リクエストなし、CORS の問題なし。
...
コードを書かずに素早く変換したい場合、[ZeroTool の画像 Base64 コンバーター](/ja/tools/image-to-base64/)は完全にブラウザ内で動作します。画像ファイルをドラッグ＆ドロップするか選択するだけで、Base64 文字列またはデータ URI を即座に取得できます。ファイルはいかなるサーバーにもアップロードされません。

**[画像 Base64 コンバーターを試す →](/ja/tools/image-to-base64/)**
