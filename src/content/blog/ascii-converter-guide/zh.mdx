...
[在线 ASCII 转换工具 →](/zh/tools/ascii-converter/)
...
[ZeroTool ASCII 转换工具](/zh/tools/ascii-converter/) 支持文本与 ASCII 码（十进制、十六进制、二进制）之间的即时互转，并提供完整字符表供查阅。在浏览器本地运行，不上传任何数据。

**[立即使用 ASCII 转换工具 →](/zh/tools/ascii-converter/)**
