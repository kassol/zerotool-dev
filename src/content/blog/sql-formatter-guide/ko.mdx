...
[SQL 즉시 포매팅하기 →](/ko/tools/sql-formatter/)
...
아무것도 설치하지 않고 즉석 포매팅이 필요할 때는 [ZeroTool의 SQL 포매터](/ko/tools/sql-formatter/)가 브라우저 안에서 처리합니다. SQL(`SELECT`, `INSERT`, `CREATE TABLE`, 스토어드 프로시저, 복잡한 멀티 JOIN 쿼리)을 붙여넣으면 바로 포매팅된 결과를 얻을 수 있습니다.
