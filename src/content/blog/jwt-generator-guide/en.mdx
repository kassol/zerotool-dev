...
The [JWT Decoder](/tools/jwt-decoder) on zerotool.dev only inspects header and payload — it does not verify signatures. To confirm a token's signature is valid, paste it into [jwt.io](https://jwt.io) and enter the same secret and algorithm.
