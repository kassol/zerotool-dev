...
**[试试 ZeroTool JSON 格式化工具 →](/zh/tools/json-formatter/)**
...
[ZeroTool JSON 格式化工具](/zh/tools/json-formatter/) 同样支持压缩——粘贴已格式化的 JSON 后点击**压缩**即可。
...
| 任务 | 工具 |
|------|------|
| 快速格式化 / 验证 | [ZeroTool JSON 格式化工具](/zh/tools/json-formatter/) |
| 命令行格式化 | `jq .` |
