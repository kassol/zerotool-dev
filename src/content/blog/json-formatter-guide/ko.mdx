...
**[ZeroTool JSON 포맷터 →](/ko/tools/json-formatter/)**
...
[ZeroTool JSON 포맷터](/ko/tools/json-formatter/)에서도 압축을 지원합니다. 포맷팅된 JSON을 붙여넣고 **Minify** 버튼을 누르면 됩니다.
...
| 작업 | 도구 |
|------|------|
| 빠른 포맷팅 / 검증 | [ZeroTool JSON 포맷터](/ko/tools/json-formatter/) |
| CLI 포맷팅 | `jq .` |
...
**[ZeroTool JSON 포맷터로 바로 시작하기 →](/ko/tools/json-formatter/)**
