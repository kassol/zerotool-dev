...
**[ZeroTool JWT デコーダー →](/ja/tools/jwt-decoder/)**
...
1. [ZeroTool JWT デコーダー](/ja/tools/jwt-decoder/)でトークンをデコードし、`exp`・`iss`・`aud`を確認
...
| タスク | ツール / アプローチ |
|--------|-----------------|
| JWTペイロードを確認 | [ZeroTool JWT デコーダー](/ja/tools/jwt-decoder/) |
...
**[ZeroTool JWT デコーダーで今すぐデコード →](/ja/tools/jwt-decoder/)**
