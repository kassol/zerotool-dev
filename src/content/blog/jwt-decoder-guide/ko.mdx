...
**[ZeroTool JWT 디코더 →](/tools/jwt-decoder)**
...
1. **토큰 디코딩** — [ZeroTool JWT 디코더](/tools/jwt-decoder)로 `exp`, `iss`, `aud` 확인
...
| 작업 | 도구/방법 |
|------|---------|
| JWT 페이로드 확인 | [ZeroTool JWT 디코더](/tools/jwt-decoder) |
...
**[ZeroTool로 JWT를 즉시 디코딩하기 →](/tools/jwt-decoder)**
